...
const DestinationDetails = () => {
  ...
  const handleNavigate = () => {
    ...
    window.open(
      `https://www.google.com/maps/search/?api=1&query=${searchQuery}, '_blank'`
    );
  };
              ...
              <div>
                <h3 className="text-base font-semibold text-gray-900 mb-1">
                  {destination.transportMode
                    ? destination.transportMode.charAt(0).toUpperCase() +
                      destination.transportMode.slice(1)
                    : "Car"}{" "}
                  Transport
                </h3>
                <p className="text-sm text-gray-600">
                  Comfortable and reliable transportation included in the
                  package
                </p>
              </div>
            </div>
              ...
              <div className="bg-gray-50 p-4 rounded-xl">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Breathtaking views of snow-capped peaks and alpine meadows
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-gray-50 p-4 rounded-xl">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Interact with local communities and learn about their
                      traditions
                    </p>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm opacity-90">
                  Our travel experts are here to help you plan your perfect trek
                </p>
              </div>
              <button
