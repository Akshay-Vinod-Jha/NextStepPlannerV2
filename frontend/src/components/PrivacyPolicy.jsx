          ...
          <div className="space-y-6 text-gray-700">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Booking Information:</strong> Trek selections, dates,
                  number of participants
                </li>
                <li>
                  <strong>Payment Information:</strong> Payment screenshots
                  (processed securely)
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Send booking confirmations and important updates via email
                </li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Payment screenshots are stored using Cloudinary's secure cloud
                  storage
                </li>
                <li>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                session, remember your preferences, and improve your browsing
