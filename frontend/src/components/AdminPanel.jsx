...
const AdminPanel = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-10 py-4 border-b border-gray-200 bg-orange-50">
        <button
          onClick={() => navigate("/")}
      ...
      <section id="destinations" className="pb-12 sm:pb-20 bg-gray-50 pt-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-lg">
              View, edit, and manage bookings for all your treks
            </p>
          </div>
          ...
          {destinations.length === 0 ? (
            <div className="bg-white rounded-xl shadow-md p-12 text-center">
              ...
              <p className="text-gray-600 mb-6 text-lg">
                Get started by adding your first trek destination
              </p>
              <button
                onClick={() => navigate("/addtrek")}
